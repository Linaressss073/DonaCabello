...
import { GetMyCentersUseCase } from './application/use-cases/get-my-centers.use-case';
...
import { GET_MY_CENTERS_PORT } from './domain/ports/in/get-my-centers.port';
...
@Module({
  ...
  providers: [
    ...
    { provide: GET_MY_CENTERS_PORT, useClass: GetMyCentersUseCase },
